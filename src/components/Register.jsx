      ...
      <div className="bg-white dark:bg-gray-700 shadow-2xl dark:shadow-lg dark:shadow-gray-700 rounded-3xl max-w-md w-full px-9 py-7">
        ...
        >
          ...
          <button
            ...
            className="w-full px-6 py-2 text-white dark:text-black text-xl bg-primary dark:bg-light hover:bg-dark dark:hover:bg-lighter rounded-3xl transition duration-200"
          >
