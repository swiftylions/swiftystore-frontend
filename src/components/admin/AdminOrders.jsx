              ...
              <div className="flex flex-wrap items-center justify-between mb-4">
                ...
                <div className="flex space-x-4 mt-4 lg:mt-0">
                  <button
                    ...
                    className="px-6 py-2 text-white dark:text-dark text-md rounded-3xl transition duration-200 bg-primary dark:bg-light hover:bg-dark dark:hover:bg-lighter"
                  >
                    Confirm
                  </button>
                  <button
                    onClick={() => handleCancel(order.orderId)}
                    className="px-6 py-2 text-white text-md rounded-3xl transition duration-200 bg-red-500 hover:bg-red-600"
                  >
                    Cancel
                  </button>
                </div>
                  ...
                  >
                    <div class="w-20 h-20 sm:w-24 md:h-30 md:w-30 sm:h-24 mb-4">
                      <img
                        ...
                        className="w-full h-full object-cover rounded-full hover:shadow-l duration-150"
                      />
                    </div>
                    <div className="">
